...
Future<Artist> fetchArtist() async {
  final response = await http.get(
      Uri.parse(
          "https://api.spotify.com/v1/me/top/artists?time_range=long_term&limit=3&offset=0"),
      headers: {
...
Future<Track> fetchTracks() async {
  final response = await http.get(
      Uri.parse(
          "https://api.spotify.com/v1/me/top/tracks?time_range=long_term&limit=3&offset=0"),
      headers: {
        HttpHeaders.acceptHeader: "Accept: application/json",
        HttpHeaders.contentTypeHeader: "Content-Type: application/json",
        HttpHeaders.authorizationHeader: "Authorization: Bearer $token"
